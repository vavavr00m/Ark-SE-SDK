...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_K4GR[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WCQI[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_MUZT4J93YD[0x4];                                     // 0x0044(0x0004) PRE-DEFINED PROPERTY
		TArray<unsigned char>                                      Script;                                                  // 0x0048(0x0010) PRE-DEFINED PROPERTY
		int                                                        MinAlignment;                                            // 0x0058(0x0004) PRE-DEFINED PROPERTY
		unsigned char                                              pad_YJCXOM15IE[0x4];                                     // 0x005C(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_L9L8[0x18];                                  // 0x0090(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MVY3[0x68];                                  // 0x0028(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_W0WK[0xF8];                                  // 0x0090(0x00F8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_5OBVGC2M7H[0x1];                                     // 0x0096(0x0001) PRE-DEFINED PROPERTY
		unsigned char                                              pad_XREI983P7X[0x1];                                     // 0x0097(0x0001) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_5ISS[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_XPYW[0x28];                                  // 0x0030(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TQB2[0x198];                                 // 0x0028(0x0198) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3AO8[0x4C0];                                 // 0x01C0(0x04C0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_U5H6[0x128];                                 // 0x01C0(0x0128) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_QJ2P[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NK6M[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_KEJV[0x40];                                  // 0x0030(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_K8YM[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1POF[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DT04[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1UWJ[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PUB4[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BF5S[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ZZ2C[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_F06A[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_CCNI[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
