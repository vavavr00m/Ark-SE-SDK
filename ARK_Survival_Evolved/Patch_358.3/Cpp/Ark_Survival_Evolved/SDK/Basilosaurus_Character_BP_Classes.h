...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_HW3Q[0x4];                                   // 0x2294(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_N5Z6[0x4];                                   // 0x22AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
