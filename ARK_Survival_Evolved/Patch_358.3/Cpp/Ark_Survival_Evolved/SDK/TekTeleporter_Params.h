...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function TekTeleporter.TekTeleporter_C.VerifyActivation
	 */
	struct ATekTeleporter_C_VerifyActivation_Params
	{	};

	/**
	 * Function TekTeleporter.TekTeleporter_C.BPNotifyPowerChanged
	 */
	struct ATekTeleporter_C_BPNotifyPowerChanged_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_44FZ[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		unsigned char                                              UnknownData_KEBE[0x2];                                   // 0x0072(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_C06P[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_N6OD[0x5];                                   // 0x000B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_Z96A[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_O2MB[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_14HN[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		TArray<struct UObject_FTransform>                          OutTransforms;                                           // 0x0010(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
