...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x0220B720
	 * 		Name   -> Function SupplyCrateSpawnInEmitter.SupplyCrateSpawnInEmitter_C.UserConstructionScript
	...
	void ASupplyCrateSpawnInEmitter_C::UserConstructionScript()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SupplyCrateSpawnInEmitter.SupplyCrateSpawnInEmitter_C.UserConstructionScript");
