...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_UR7K[0x8];                                   // 0x00D8(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_S3H0[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TM0P[0x8];                                   // 0x00D8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_B5BQ[0x3];                                   // 0x047D(0x0003) MISSED OFFSET (PADDING)
