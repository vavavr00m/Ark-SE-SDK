...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x0220B720
	 * 		Name   -> Function WorldBuff_Asteroid_CrateQuality_Up.WorldBuff_Asteroid_CrateQuality_Up_C.ExecuteUbergraph_WorldBuff_Asteroid_CrateQuality_Up
	 * 		Flags  -> ()
	 * Parameters:
	 * 		int32_t                                            EntryPoint                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UWorldBuff_Asteroid_CrateQuality_Up_C::ExecuteUbergraph_WorldBuff_Asteroid_CrateQuality_Up(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WorldBuff_Asteroid_CrateQuality_Up.WorldBuff_Asteroid_CrateQuality_Up_C.ExecuteUbergraph_WorldBuff_Asteroid_CrateQuality_Up");
