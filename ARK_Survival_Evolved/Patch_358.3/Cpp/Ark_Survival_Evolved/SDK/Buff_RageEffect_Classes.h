...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_HY6P[0x4];                                   // 0x0994(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EJ11[0x2];                                   // 0x09AA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
