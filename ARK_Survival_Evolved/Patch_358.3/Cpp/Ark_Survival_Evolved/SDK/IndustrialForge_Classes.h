...
namespace CG
{
	...
	{
	public:
		class UPrimalInventoryBP_IndustrialForge_C*                PrimalInventoryBP_IndustrialForge_C1;                    // 0x0E10(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
	...
	public:
		...
		void ExecuteUbergraph_IndustrialForge(int32_t EntryPoint);
