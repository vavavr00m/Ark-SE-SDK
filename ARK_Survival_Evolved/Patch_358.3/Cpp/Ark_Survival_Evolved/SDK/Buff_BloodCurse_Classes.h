...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3DVI[0x4];                                   // 0x0994(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UClass*                                              DamageCauserBuff;                                        // 0x0998(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void ExecuteUbergraph_Buff_BloodCurse(int32_t EntryPoint);
