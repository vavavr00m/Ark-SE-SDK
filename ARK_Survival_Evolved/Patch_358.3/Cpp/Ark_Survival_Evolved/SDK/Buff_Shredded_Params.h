...
namespace CG
{
	 ...
	 */
	struct ABuff_Shredded_C_BuffAdjustDamage_Params
	{
	public:
		float                                                      Damage;                                                  // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_4MFC[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct ABuff_Shredded_C_BPAdjustStatusValueModification_Params
	{
	public:
		...
		unsigned char                                              UnknownData_AK87[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		unsigned char                                              UnknownData_SHD5[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		float                                                      ReturnValue;                                             // 0x001C(0x0004)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
	};

	/**
	 * Function Buff_Shredded.Buff_Shredded_C.UserConstructionScript
	 */
	struct ABuff_Shredded_C_UserConstructionScript_Params
	{	};

	/**
	 * Function Buff_Shredded.Buff_Shredded_C.ExecuteUbergraph_Buff_Shredded
	 */
	struct ABuff_Shredded_C_ExecuteUbergraph_Buff_Shredded_Params
	{
	public:
