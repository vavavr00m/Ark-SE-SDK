...
namespace CG
{
	 ...
	 */
	struct UZipline_IsTargetPlayerOrTame_DR_C_ReceiveConditionCheck_Params
	{
	public:
	 ...
	 */
	struct UZipline_IsTargetPlayerOrTame_DR_C_ExecuteUbergraph_Zipline_IsTargetPlayerOrTame_DR_Params
	{
	public:
