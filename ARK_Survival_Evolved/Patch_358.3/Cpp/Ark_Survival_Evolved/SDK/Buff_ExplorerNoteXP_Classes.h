...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3FBN[0x4];                                   // 0x0984(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Buff_ExplorerNoteXP(int32_t EntryPoint);
