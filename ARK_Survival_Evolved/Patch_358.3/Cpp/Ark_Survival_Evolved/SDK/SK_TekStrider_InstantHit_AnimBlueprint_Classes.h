...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_GEUZ[0x7];                                   // 0x0421(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S4IA[0x7];                                   // 0x0431(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MZMF[0x6];                                   // 0x0442(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FBG9[0x1];                                   // 0x0453(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
