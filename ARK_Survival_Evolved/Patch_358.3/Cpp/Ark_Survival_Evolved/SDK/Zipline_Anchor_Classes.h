...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_D54E[0x6];                                   // 0x0B02(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7CNC[0x2];                                   // 0x0B1A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_190P[0x3];                                   // 0x0B2D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LOPT[0xA];                                   // 0x0B36(0x000A) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
