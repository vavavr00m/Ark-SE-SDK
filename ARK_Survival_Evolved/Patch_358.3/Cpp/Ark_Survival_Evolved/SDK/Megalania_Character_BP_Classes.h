...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_D191[0x4];                                   // 0x2FBC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DPD0[0x4];                                   // 0x2FCC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
