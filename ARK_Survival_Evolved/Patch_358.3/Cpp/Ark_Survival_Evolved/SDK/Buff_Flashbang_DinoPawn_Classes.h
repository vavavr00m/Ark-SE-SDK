...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9AE6[0x6];                                   // 0x09AA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WUDZ[0x3];                                   // 0x09C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
