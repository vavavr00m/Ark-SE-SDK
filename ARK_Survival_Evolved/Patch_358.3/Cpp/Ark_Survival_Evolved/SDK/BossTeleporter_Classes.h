...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_QNJH[0x4];                                   // 0x099C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_R9EC[0x10];                                  // 0x09D8(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		class FText                                                SP_TeleportText;                                         // 0x09E8(0x0018) ELEMENT_SIZE_MISMATCH Edit, BlueprintVisible, DisableEditOnInstance
		unsigned char                                              UnknownData_YFBV[0x10];                                  // 0x0A00(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		bool                                                       AllowFlyers;                                             // 0x0A10(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_0MW9[0x7];                                   // 0x0A11(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_I42V[0x3];                                   // 0x0A29(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WOOP[0x2];                                   // 0x0A4E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MK2G[0x1];                                   // 0x0A5F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
