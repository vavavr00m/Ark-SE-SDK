...
namespace CG
{
	...
	{
	public:
		class USkeletalMeshComponent*                              SkeletalMesh1;                                           // 0x0E10(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		class UPrimalInventoryBP_TekTransmitter_C*                 PrimalInventoryBP_TekTransmitter_C1;                     // 0x0E18(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
