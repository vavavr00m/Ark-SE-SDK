...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MCNW[0x5];                                   // 0x0D73(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8I80[0x7];                                   // 0x0D81(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
