...
namespace CG
{
	...
	{
	public:
		class UPrimalInventoryBP_IndustrialGrinder_C*              PrimalInventoryBP_IndustrialGrinder_C1;                  // 0x0E10(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		...
		int32_t                                                    MaxQuantityToGrind;                                      // 0x0E40(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		int32_t                                                    MaxItemsToGivePerGrind;                                  // 0x0E44(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		float                                                      GrindGiveItemsPercent;                                   // 0x0E48(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
