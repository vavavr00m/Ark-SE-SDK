...
namespace CG
{
	 ...
	 * Size -> 0x0018 (FullSize[0x0E78] - InheritedSize[0x0E60])
	 */
	class AWeapLasso_C : public APrimalWeaponGrapplingHook
	{
	public:
		class UStaticMeshComponent*                                StaticMesh1;                                             // 0x0E60(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		class USceneComponent*                                     CableStart3P;                                            // 0x0E68(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		class USceneComponent*                                     CableStart1P;                                            // 0x0E70(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
