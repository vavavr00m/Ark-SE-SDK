...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_B4WW[0x7];                                   // 0x0AE9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Furniture_Wall_Wreath(int32_t EntryPoint);
