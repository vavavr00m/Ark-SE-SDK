...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5TMG[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_IsFlyingPhysics(int32_t EntryPoint);
