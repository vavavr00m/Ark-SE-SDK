...
namespace CG
{
	 ...
	 * Size -> 0x0022 (FullSize[0x00B2] - InheritedSize[0x0090])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_3VDL[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class ADeathItemCache_C*                                   K2Node_DynamicCast_AsDeathItemCache_C;                   // 0x00A8(0x0008) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor
		...
		bool                                                       CallFunc_Not_PreBool_ReturnValue;                        // 0x00B1(0x0001) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor

	public:
		void ReceiveConditionCheck(class AActor* OwnerActor);
		void ExecuteUbergraph_BTD_Fjordhawk_HasLootTarget(int32_t EntryPoint);
