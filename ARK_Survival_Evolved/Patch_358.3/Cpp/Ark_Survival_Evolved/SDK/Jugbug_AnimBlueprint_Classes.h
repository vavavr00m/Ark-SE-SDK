...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_Z0AW[0x4];                                   // 0x13AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VYQW[0x3];                                   // 0x13C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
