...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x0220B720
	 * 		Name   -> Function FeedingTroughBaseBP.FeedingTroughBaseBP_C.ServerRequest_TurnOffAllShowarea
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 * Parameters:
	...
	void AFeedingTroughBaseBP_C::ServerRequest_TurnOffAllShowarea(class APlayerController* PC)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FeedingTroughBaseBP.FeedingTroughBaseBP_C.ServerRequest_TurnOffAllShowarea");
