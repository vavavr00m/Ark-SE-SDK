...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_7YON[0x3];                                   // 0x1C49(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WT15[0x4];                                   // 0x1C5C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
