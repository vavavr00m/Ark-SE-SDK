...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_2FK2[0x3];                                   // 0x0F21(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UA2F[0x1];                                   // 0x0F2B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
