...
namespace CG
{
	 ...
	 * Size -> 0x0018 (FullSize[0x0F68] - InheritedSize[0x0F50])
	 */
	...
	public:
		...
		class USoundBase*                                          OpenedSound;                                             // 0x0F58(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		class USoundBase*                                          ClosedSound;                                             // 0x0F60(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
