...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ZJUZ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		class ADino_Character_BP_DivingFlyer_C*                    Target;                                                  // 0x0008(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};
	...
	{
	public:
		class ADino_Character_BP_DivingFlyer_C*                    Target;                                                  // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};
