...
namespace CG
{
	 ...
	 */
	class UIsSwimming_DK_C : public UBTDecorator_BlueprintBase
	{
	public:
		...
		unsigned char                                              UnknownData_FD2Z[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       CallFunc_IsPrimalCharSwimming_ReturnValue;               // 0x00B9(0x0001) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor

	public:
		void ReceiveConditionCheck(class AActor* OwnerActor);
		void ExecuteUbergraph_IsSwimming_DK(int32_t EntryPoint);
