...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_AZX5[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_BP4W[0x10];                                  // 0x0060(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                              UnknownData_OW9R[0x4];                                   // 0x01DC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SXVR[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
