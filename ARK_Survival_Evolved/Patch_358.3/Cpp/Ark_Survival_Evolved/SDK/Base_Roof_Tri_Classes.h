...
namespace CG
{
	 ...
	 * Size -> 0x0001 (FullSize[0x0AE9] - InheritedSize[0x0AE8])
	 */
	class ABase_Roof_Tri_C : public AStructureBaseBP_C
	{
	public:
		bool                                                       IsGlass;                                                 // 0x0AE8(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
