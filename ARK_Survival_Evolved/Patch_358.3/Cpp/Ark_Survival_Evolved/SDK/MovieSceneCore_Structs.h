...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_DOR2[0x10];                                  // 0x0028(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		class UClass*                                              GeneratedClass;                                          // 0x0038(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_J86R[0x8];                                   // 0x0040(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		struct FGuid                                               Guid;                                                    // 0x0000(0x0010) ZeroConstructor
		class FText                                                Name;                                                    // 0x0010(0x0018) ELEMENT_SIZE_MISMATCH
		unsigned char                                              UnknownData_LWSN[0x10];                                  // 0x0028(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                              UnknownData_R1M4[0x10];                                  // 0x0028(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
