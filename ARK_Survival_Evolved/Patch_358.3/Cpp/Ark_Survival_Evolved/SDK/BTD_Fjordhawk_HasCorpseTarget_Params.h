...
namespace CG
{
	 ...
	 */
	struct UBTD_Fjordhawk_HasCorpseTarget_C_ReceiveConditionCheck_Params
	{
	public:
	 ...
	 */
	struct UBTD_Fjordhawk_HasCorpseTarget_C_ExecuteUbergraph_BTD_Fjordhawk_HasCorpseTarget_Params
	{
	public:
