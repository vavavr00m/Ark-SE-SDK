...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RZY2[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1NZJ[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_XS0R[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3LQF[0x67];                                  // 0x0051(0x0067) MISSED OFFSET (PADDING)
