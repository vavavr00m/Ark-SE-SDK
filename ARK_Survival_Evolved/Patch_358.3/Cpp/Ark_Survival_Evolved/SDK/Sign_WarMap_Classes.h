...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PZJD[0x7];                                   // 0x0B09(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZZI4[0x5];                                   // 0x0B1B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
