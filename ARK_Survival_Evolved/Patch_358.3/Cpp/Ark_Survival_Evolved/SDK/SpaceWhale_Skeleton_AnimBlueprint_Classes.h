...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1VFR[0x4];                                   // 0x1BD4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Q5VE[0x4];                                   // 0x1BE4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J2MA[0x3];                                   // 0x1BF1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
