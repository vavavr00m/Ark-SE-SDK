...
namespace CG
{
	 ...
	 */
	void ABuff_TekArmor_C::SpawnFX(class UParticleSystem* EmitterTemplate, struct UObject_FTransform* InTransform, class USoundBase* Sound, float VolumeMultiplier, float PitchMultiplier)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Function:
	 * 		RVA    -> 0x0220B720
	 * 		Name   -> Function Buff_TekArmor.Buff_TekArmor_C.Consume Element After Time
	 * 		Flags  -> (Public, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		float                                              DeltaTime                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 * 		int32_t                                            elementCost                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void ABuff_TekArmor_C::ConsumeElementAfterTime(float DeltaTime, int32_t elementCost)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Buff_TekArmor.Buff_TekArmor_C.Consume Element After Time");
		
		ABuff_TekArmor_C_ConsumeElementAfterTime_Params params {};
