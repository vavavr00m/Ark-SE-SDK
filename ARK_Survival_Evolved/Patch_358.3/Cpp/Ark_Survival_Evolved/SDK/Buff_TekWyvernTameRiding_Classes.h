...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_P5TB[0x4];                                   // 0x0984(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2KMS[0x4];                                   // 0x09BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U5T1[0x3];                                   // 0x09D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void GetExtraTamingEffectivenessModifier(float* ExtraEffectiveness);
		...
		void ExecuteUbergraph_Buff_TekWyvernTameRiding(int32_t EntryPoint);
