...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_QBM4[0x7];                                   // 0x0B59(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<struct UObject_FTransform>                          ExtraParticleSystemTransforms;                           // 0x0B60(0x0010) Edit, BlueprintVisible, Net, ZeroConstructor, ExposeOnSpawn
		...
		unsigned char                                              UnknownData_DR3W[0x3];                                   // 0x0B8D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UQ1K[0x3];                                   // 0x0B95(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PZ8F[0x3];                                   // 0x0B9D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct UObject_FTransform                                  CallFunc_Array_Get_Item;                                 // 0x0BA0(0x0030) Transient, DuplicateTransient, IsPlainOldData, NoDestructor
		...
		unsigned char                                              UnknownData_M9ME[0x4];                                   // 0x0BF4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_637D[0x3];                                   // 0x0C01(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
