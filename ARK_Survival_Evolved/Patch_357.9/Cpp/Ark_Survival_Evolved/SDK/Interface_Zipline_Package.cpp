...
namespace CG
{
	 ...
	 */
	void UInterface_Zipline_C::GetProcessMovetoOrder_InterfaceCall(bool* _return_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	void UInterface_Zipline_C::MultiSoftSetTransform_InterfaceCall(const struct UObject_FTransform& NewTransform)
	{
		static UFunction* fn = nullptr;
		if (!fn)
