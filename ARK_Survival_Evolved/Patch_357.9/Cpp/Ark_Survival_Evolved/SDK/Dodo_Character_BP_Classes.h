...
namespace CG
{
	...
	{
	public:
		class UDinoCharacterStatusComponent_BP_Dodo_C*             DinoCharacterStatus_BP_Dodo_C1;                          // 0x2288(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
