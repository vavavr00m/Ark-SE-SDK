...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_42Z4[0x2];                                   // 0x0926(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NLZQ[0x7];                                   // 0x0939(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
