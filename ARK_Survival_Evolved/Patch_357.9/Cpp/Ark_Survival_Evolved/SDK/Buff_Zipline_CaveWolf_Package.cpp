...
namespace CG
{
	 ...
	 */
	void ABuff_Zipline_CaveWolf_C::SetAttachedCharacterTransform(const struct UObject_FTransform& NewTransform)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	void ABuff_Zipline_CaveWolf_C::CanZiplineFlip(bool* _return_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		bool                                               _return_                                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void ABuff_Zipline_CaveWolf_C::RotationNearlyEqual(const struct FRotator& rotA, const struct FRotator& RotB, float ErrorTolerance, bool* _return_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
