...
namespace CG
{
	...
	public:
		...
		class USkeletalMeshComponent*                              SkeletalMesh1;                                           // 0x10D0(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		class USphereComponent*                                    StasisComponent;                                         // 0x10D8(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
