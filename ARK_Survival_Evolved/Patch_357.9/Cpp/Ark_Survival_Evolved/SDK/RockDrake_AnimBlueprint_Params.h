...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_G42C[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	{
	public:
		class ARockDrake_Character_BP_C*                           DrakeRef;                                                // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		float                                                      YawTurnRate;                                             // 0x0008(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};
