...
namespace CG
{
	...
	{
	public:
		struct UObject_FTransform                                  WorldTransform;                                          // 0x0000(0x0030)  (Parm, OutParm, IsPlainOldData, NoDestructor)
		...
		unsigned char                                              UnknownData_M391[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
