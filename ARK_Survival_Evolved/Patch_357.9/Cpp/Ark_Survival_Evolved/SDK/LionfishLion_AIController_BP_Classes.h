...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NM13[0x2];                                   // 0x091A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_99YW[0x7];                                   // 0x0929(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
