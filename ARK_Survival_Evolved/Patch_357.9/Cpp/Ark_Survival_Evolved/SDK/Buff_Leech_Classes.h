...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UZSA[0x8];                                   // 0x09C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct UObject_FTransform                                  CallFunc_AddComponent_RelativeTransform_AddComponentDefaultTransform; // 0x09D0(0x0030) Transient, DuplicateTransient, IsPlainOldData, NoDestructor
