...
namespace CG
{
	...
	{
	public:
		class UDinoCharacterStatusComponent_BP_Trilobite_C*        DinoCharacterStatus_BP_Trilobite_C1;                     // 0x2288(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor

	public:
		bool BP_ForceAllowAddBuff(class UClass* BuffClass);
		void UserConstructionScript();
		void ExecuteUbergraph_Trilobite_Character(int32_t EntryPoint);
