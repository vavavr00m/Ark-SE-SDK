...
namespace CG
{
	 ...
	 */
	void ARockDrake_Character_BP_C::GetCorrectSurfaceTraceOffsetTransforms(bool overrideUseMap, TArray<bool>* newUseMp, TArray<struct UObject_FTransform>* offsetTransforms, TArray<int32_t>* TraceIndeces)
	{
		static UFunction* fn = nullptr;
		if (!fn)
