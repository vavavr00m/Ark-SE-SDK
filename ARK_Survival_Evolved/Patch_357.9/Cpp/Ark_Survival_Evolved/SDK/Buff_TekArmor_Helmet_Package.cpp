...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x022073A0
	 * 		Name   -> Function Buff_TekArmor_Helmet.Buff_TekArmor_Helmet_C.Server_Active
	 * 		Flags  -> (Net, NetReliable, NetServer, BlueprintCallable, BlueprintEvent)
	 */
	void ABuff_TekArmor_Helmet_C::Server_Active()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Buff_TekArmor_Helmet.Buff_TekArmor_Helmet_C.Server_Active");
		
		ABuff_TekArmor_Helmet_C_Server_Active_Params params {};
