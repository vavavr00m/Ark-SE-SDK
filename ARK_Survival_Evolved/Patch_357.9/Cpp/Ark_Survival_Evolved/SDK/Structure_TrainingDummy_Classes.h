...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_4RV0[0x3];                                   // 0x0F11(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A3MR[0x10];                                  // 0x0F30(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
