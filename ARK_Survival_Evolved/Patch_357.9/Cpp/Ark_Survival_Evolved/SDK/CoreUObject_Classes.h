...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_OC5J[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7H8P[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_ATMHCTO09E[0x4];                                     // 0x0044(0x0004) PRE-DEFINED PROPERTY
		TArray<unsigned char>                                      Script;                                                  // 0x0048(0x0010) PRE-DEFINED PROPERTY
		int                                                        MinAlignment;                                            // 0x0058(0x0004) PRE-DEFINED PROPERTY
		unsigned char                                              pad_4B8B03TNRF[0x4];                                     // 0x005C(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_HY4N[0x18];                                  // 0x0090(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_6Z8F[0x68];                                  // 0x0028(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_W3CF[0xF8];                                  // 0x0090(0x00F8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_GF7T5WCMJS[0x1];                                     // 0x0096(0x0001) PRE-DEFINED PROPERTY
		unsigned char                                              pad_YG9PYKZQYU[0x1];                                     // 0x0097(0x0001) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_HNEU[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1GSF[0x28];                                  // 0x0030(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_N9L8[0x198];                                 // 0x0028(0x0198) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LMVM[0x4C0];                                 // 0x01C0(0x04C0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Y4BV[0x128];                                 // 0x01C0(0x0128) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EQK5[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_W76B[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BBO6[0x40];                                  // 0x0030(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_G88P[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_34FG[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Y3GR[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7OZE[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_K75D[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TNSM[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_IBEJ[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1LMX[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WE7S[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
