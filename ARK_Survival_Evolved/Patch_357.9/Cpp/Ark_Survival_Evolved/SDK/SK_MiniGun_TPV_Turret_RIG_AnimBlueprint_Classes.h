...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_24F9[0x4];                                   // 0x051C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class AStructureMinigunBP_C*                               K2Node_DynamicCast_AsStructureMinigunBP_C;               // 0x0528(0x0008) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor
		...
		unsigned char                                              UnknownData_SYQP[0x3];                                   // 0x0531(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
