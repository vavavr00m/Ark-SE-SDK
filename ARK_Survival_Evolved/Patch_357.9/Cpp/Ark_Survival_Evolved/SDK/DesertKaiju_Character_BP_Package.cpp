...
namespace CG
{
	 ...
	 */
	void ADesertKaiju_Character_BP_C::ActorIsKaiju(class AActor* Actor, bool* _return_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Parameters:
	 * 		struct UObject_FTransform                          ActualTransform                                            (Parm, OutParm, IsPlainOldData, NoDestructor)
	 */
	void ADesertKaiju_Character_BP_C::GetKaijuTransform(struct UObject_FTransform* ActualTransform)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	void ADesertKaiju_Character_BP_C::GetLookDir(struct FVector* _return_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
