...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_VVDW[0x3];                                   // 0x29F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GY25[0x6];                                   // 0x2A02(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FLM6[0x1];                                   // 0x2A33(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
