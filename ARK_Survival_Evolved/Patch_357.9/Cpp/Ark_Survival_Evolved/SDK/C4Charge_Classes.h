...
namespace CG
{
	 ...
	 * Size -> 0x0008 (FullSize[0x0B88] - InheritedSize[0x0B80])
	 */
	class AC4Charge_C : public APrimalStructureExplosive
	{
	public:
		class USphereComponent*                                    StasisComponent;                                         // 0x0B80(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
