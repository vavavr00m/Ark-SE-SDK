...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UDOV[0x4];                                   // 0x340C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FKZA[0x2];                                   // 0x343A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
