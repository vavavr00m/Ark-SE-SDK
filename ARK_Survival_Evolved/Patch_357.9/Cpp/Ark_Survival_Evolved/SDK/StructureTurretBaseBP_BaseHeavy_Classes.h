...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_VJ89[0x7];                                   // 0x0F59(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XMZZ[0x3];                                   // 0x0F75(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
