...
namespace CG
{
	...
	{
	public:
		float                                                      LocalParticleFadeout_Value_8B257A684194C3E57DAC47A6569C0378; // 0x0980(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor
		ETimelineDirection                                         LocalParticleFadeout__Direction_8B257A684194C3E57DAC47A6569C0378; // 0x0984(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_W9WN[0x3];                                   // 0x0985(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_637M[0x7];                                   // 0x09C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct UObject_FTransform                                  CallFunc_MakeTransform_ReturnValue;                      // 0x09F0(0x0030) Transient, DuplicateTransient, IsPlainOldData, NoDestructor
		...
		unsigned char                                              UnknownData_C3NG[0x7];                                   // 0x0A31(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Buff_Sunlight(int32_t EntryPoint);
