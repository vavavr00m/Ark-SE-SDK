...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_QRUF[0xD0];                                  // 0x0028(0x00D0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_467Y[0x6];                                   // 0x00FA(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XRWS[0x68];                                  // 0x0048(0x0068) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0028(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_0VSA[0x38];                                  // 0x0048(0x0038) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0020 (FullSize[0x34358] - InheritedSize[0x34338])
	 */
	class UIpConnection : public UNetConnection
	{
	public:
		unsigned char                                              UnknownData_BUX3[0x20];                                  // 0x34338(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LUYS[0x3];                                   // 0x03A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		uint32_t                                                   MaxPortCountToTry;                                       // 0x03A4(0x0004) ZeroConstructor, Config, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_34Q0[0x18];                                  // 0x03A8(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0028(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_R0T5[0x10];                                  // 0x0048(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0028(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_PJIN[0x38];                                  // 0x0048(0x0038) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BJ2V[0x8];                                   // 0x0468(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YBKQ[0x8];                                   // 0x0488(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8JPM[0x4];                                   // 0x0494(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class AOnlineBeaconClient*>                         ClientActors;                                            // 0x0498(0x0010) ZeroConstructor
		unsigned char                                              UnknownData_OVVM[0xA0];                                  // 0x04A8(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FLEW[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JUST[0x28];                                  // 0x0490(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_WIW7[0x50];                                  // 0x0498(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0028(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_MWFR[0x10];                                  // 0x0048(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0028(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_F0XL[0x28];                                  // 0x0048(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0028(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_GW8Q[0x10];                                  // 0x0048(0x0010) MISSED OFFSET (PADDING)
