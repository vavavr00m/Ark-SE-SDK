...
namespace CG
{
	 ...
	 */
	struct UZipline_ResetProcessMoveToOrder_TK_C_ReceiveExecute_Params
	{
	public:
	 ...
	 */
	struct UZipline_ResetProcessMoveToOrder_TK_C_ExecuteUbergraph_Zipline_ResetProcessMoveToOrder_TK_Params
	{
	public:
