...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NPKA[0x5];                                   // 0x098B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8ZQA[0x3];                                   // 0x099D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
