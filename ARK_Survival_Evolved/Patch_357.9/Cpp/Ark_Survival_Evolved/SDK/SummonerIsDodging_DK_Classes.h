...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_EVNV[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class ASummoner_Character_BP_C*                            K2Node_DynamicCast_AsSummoner_Character_BP_C;            // 0x00B0(0x0008) ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor
	...
	public:
		...
		void ExecuteUbergraph_SummonerIsDodging_DK(int32_t EntryPoint);
