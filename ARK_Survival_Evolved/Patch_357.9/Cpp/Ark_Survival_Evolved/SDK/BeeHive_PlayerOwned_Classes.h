...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_PQSM[0x2];                                   // 0x0EEE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A32N[0x5];                                   // 0x0F4B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
