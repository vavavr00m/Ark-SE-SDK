...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x022073A0
	 * 		Name   -> Function PlayerCameraBlueprint.PlayerCameraBlueprint_C.UserConstructionScript
	...
	void APlayerCameraBlueprint_C::UserConstructionScript()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function PlayerCameraBlueprint.PlayerCameraBlueprint_C.UserConstructionScript");
