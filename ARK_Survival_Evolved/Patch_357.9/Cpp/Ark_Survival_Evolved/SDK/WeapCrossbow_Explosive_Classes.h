...
namespace CG
{
	 ...
	 * Size -> 0x0008 (FullSize[0x0E58] - InheritedSize[0x0E50])
	 */
	class AWeapCrossbow_Explosive_C : public AWeapCrossbow_C
	{
	public:
		class UStaticMeshComponent*                                ArrowMesh1P;                                             // 0x0E50(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
