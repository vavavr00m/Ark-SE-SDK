...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x022073A0
	 * 		Name   -> Function TekTeleporter.TekTeleporter_C.VerifyActivation
	 * 		Flags  -> (Public, BlueprintCallable, BlueprintEvent)
	 */
	void ATekTeleporter_C::VerifyActivation()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TekTeleporter.TekTeleporter_C.VerifyActivation");
		
		ATekTeleporter_C_VerifyActivation_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x022073A0
	 * 		Name   -> Function TekTeleporter.TekTeleporter_C.BPNotifyPowerChanged
	 * 		Flags  -> (Event, Public, BlueprintCallable, BlueprintEvent)
	 */
	void ATekTeleporter_C::BPNotifyPowerChanged()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TekTeleporter.TekTeleporter_C.BPNotifyPowerChanged");
		
		ATekTeleporter_C_BPNotifyPowerChanged_Params params {};
