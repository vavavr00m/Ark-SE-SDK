...
namespace CG
{
	...
	{
	public:
		class UStaticMeshComponent*                                RightTarget;                                             // 0x0AE8(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		class UStaticMeshComponent*                                LeftTarget;                                              // 0x0AF0(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
