...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PBZ3[0x4];                                   // 0x0984(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8HNN[0x3];                                   // 0x0999(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4RF5[0x10];                                  // 0x09D8(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_H7JN[0x10];                                  // 0x0A60(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
