...
namespace CG
{
	 ...
	 * Size -> 0x0008 (FullSize[0x0FA8] - InheritedSize[0x0FA0])
	 */
	class AStructureTurretBaseBP_Heavy_C : public AStructureTurretBaseBP_BaseHeavy_C
	{
	public:
		class UPrimalInventoryBP_HeavyTurret_C*                    PrimalInventoryBP_HeavyTurret_C1;                        // 0x0FA0(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
