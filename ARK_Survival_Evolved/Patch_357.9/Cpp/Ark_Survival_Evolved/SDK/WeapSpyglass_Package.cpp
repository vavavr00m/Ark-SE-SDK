...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x022073A0
	 * 		Name   -> Function WeapSpyglass.WeapSpyglass_C.ForceDisableCameraOverrides
	...
	bool AWeapSpyglass_C::ForceDisableCameraOverrides()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WeapSpyglass.WeapSpyglass_C.ForceDisableCameraOverrides");
