...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_BUDY[0x18];                                  // 0x04C0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       bLOSflag : 1;                                            // 0x04D8(0x0001) BIT_FIELD NoDestructor
		bool                                                       bSkipExtraLOSChecks : 1;                                 // 0x04D8(0x0001) BIT_FIELD NoDestructor
		bool                                                       bAllowStrafe : 1;                                        // 0x04D8(0x0001) BIT_FIELD NoDestructor
		bool                                                       bWantsPlayerState : 1;                                   // 0x04D8(0x0001) BIT_FIELD NoDestructor
		bool                                                       bUse3DGoalRadius : 1;                                    // 0x04D8(0x0001) BIT_FIELD Edit, DisableEditOnInstance, NoDestructor
		bool                                                       bForceInputAcceptanceRadius : 1;                         // 0x04D8(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor
		unsigned char                                              UnknownData_K1DA[0x7];                                   // 0x04D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XJE4[0x70];                                  // 0x0520(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       UnknownData_D9X6 : 1;                                    // 0x0590(0x0001) BIT_FIELD (PADDING)
		bool                                                       bLastMoveReachedGoal : 1;                                // 0x0590(0x0001) BIT_FIELD BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor
		bool                                                       bLastRequestedMoveToLocationWasPlayerCommand : 1;        // 0x0590(0x0001) BIT_FIELD BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor
		unsigned char                                              UnknownData_URNI[0x7];                                   // 0x0591(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_312J[0x8];                                   // 0x0048(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_5N4O[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_L5SU[0x8];                                   // 0x0060(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UOOQ[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_T3OB[0x18];                                  // 0x0048(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3QMS[0x8];                                   // 0x0108(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BEDU[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0Y8D[0x2C];                                  // 0x008C(0x002C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SJIS[0x4];                                   // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class AAIController*                                       AIOwner;                                                 // 0x00F0(0x0008) ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected
		unsigned char                                              UnknownData_1TVA[0x58];                                  // 0x00F8(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		ECorePerceptionTypes                                       DominantSense;                                           // 0x0150(0x0001) ZeroConstructor, Config, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_HPMD[0x37];                                  // 0x0151(0x0037) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KL65[0x20];                                  // 0x0030(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3WIA[0x60];                                  // 0x0050(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YY4P[0x4];                                   // 0x00B8(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GD7O[0x4];                                   // 0x00C4(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_C6D4[0x8];                                   // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_T3PI[0x28];                                  // 0x00F0(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_03CB[0x48];                                  // 0x0118(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UBTNode*>                                     NodeInstances;                                           // 0x0160(0x0010) ZeroConstructor, Transient, Protected
		unsigned char                                              UnknownData_2UMY[0x80];                                  // 0x0170(0x0080) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_O3CE[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JFXP[0x8];                                   // 0x0058(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1G64[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_8W44[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LO4C[0x8];                                   // 0x0040(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KOET[0x88];                                  // 0x00E8(0x0088) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MZBY[0x7];                                   // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		bool                                                       UnknownData_89EL : 7;                                    // 0x0058(0x0001) BIT_FIELD (PADDING)
		bool                                                       bInverseCondition : 1;                                   // 0x0058(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              UnknownData_K2ZP[0x3];                                   // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		EBTFlowAbortMode                                           FlowAbortMode;                                           // 0x005C(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected
		unsigned char                                              UnknownData_35NN[0x3];                                   // 0x005D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_UX4M[0x8];                                   // 0x0088(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4OQ9[0x6];                                   // 0x00BA(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LJ9P[0x20];                                  // 0x0060(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       bShowPropertyDetails : 1;                                // 0x0080(0x0001) BIT_FIELD Edit, DisableEditOnTemplate, NoDestructor, Protected
		unsigned char                                              UnknownData_O0E7[0xF];                                   // 0x0081(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_WKM8[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TQZM[0x8];                                   // 0x00B8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_NOSA[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JJH0[0x8];                                   // 0x00E0(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_HX0X[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_R55H[0x3];                                   // 0x00B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		EPathExistanceQueryType                                    PathQueryType;                                           // 0x00B4(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_MGYC[0x3];                                   // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		float                                                      ConeHalfAngle;                                           // 0x0060(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_SH68[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FBlackboardKeySelector                              ConeOrigin;                                              // 0x0068(0x0028) Edit
		...
		unsigned char                                              UnknownData_0TER[0x7];                                   // 0x00B9(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JRLH[0x3];                                   // 0x0065(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KY82[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_XRHG[0x10];                                  // 0x0068(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       bShowPropertyDetails : 1;                                // 0x0078(0x0001) BIT_FIELD Edit, DisableEditOnTemplate, NoDestructor, Protected
		unsigned char                                              UnknownData_793R[0x7];                                   // 0x0079(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GPYW[0x7];                                   // 0x0081(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0VGT[0x3];                                   // 0x0085(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		float                                                      AcceptableRadius;                                        // 0x0080(0x0004) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_12MZ[0x4];                                   // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P0XQ[0x7];                                   // 0x0091(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_R2N8[0x4];                                   // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YN77[0x7];                                   // 0x00B1(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_G1BI[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_9Y69[0x18];                                  // 0x0058(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       bShowPropertyDetails : 1;                                // 0x0070(0x0001) BIT_FIELD Edit, DisableEditOnTemplate, NoDestructor, Protected
		unsigned char                                              UnknownData_QJ9E[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MODC[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MTFR[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RSZB[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2GE6[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_66XI[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		struct FEnvFloatParam                                      Radius;                                                  // 0x0040(0x000C) Edit, DisableEditOnInstance
		unsigned char                                              UnknownData_6ODM[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FText                                                GeneratorsActionDescription;                             // 0x0050(0x0018) ELEMENT_SIZE_MISMATCH Edit
		unsigned char                                              UnknownData_7406[0x10];                                  // 0x0068(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_IU6Y[0x8];                                   // 0x0088(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_C2OO[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QFMC[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_ED4A[0x7];                                   // 0x00E1(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_QJVU[0x30];                                  // 0x0028(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_90W4[0x2];                                   // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CXP5[0x1];                                   // 0x0063(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6OE8[0x2];                                   // 0x0066(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3RPP[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FEnvFloatParam                                      Weight;                                                  // 0x0084(0x000C) Edit, DisableEditOnInstance
		unsigned char                                              UnknownData_IM5B[0x8];                                   // 0x0090(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       UnknownData_N1RB : 1;                                    // 0x0098(0x0001) BIT_FIELD (PADDING)
		...
		unsigned char                                              UnknownData_EG38[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_INLH[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_BEU8[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8PH6[0x4];                                   // 0x00D4(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9T40[0x4];                                   // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_WUFI[0x20];                                  // 0x0670(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool                                                       bDrawLabels : 1;                                         // 0x06E0(0x0001) BIT_FIELD Edit, NoDestructor
		bool                                                       bDrawFailedItems : 1;                                    // 0x06E0(0x0001) BIT_FIELD Edit, NoDestructor
		bool                                                       bReRunQueryOnlyOnFinishedMove : 1;                       // 0x06E0(0x0001) BIT_FIELD Edit, NoDestructor
		bool                                                       bShouldBeVisibleInGame : 1;                              // 0x06E0(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              UnknownData_3M6W[0x3];                                   // 0x06E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		EEnvQueryRunMode                                           QueryingMode;                                            // 0x06E4(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_N4XW[0x2B];                                  // 0x06E5(0x002B) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_K60C[0x8];                                   // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ITR1[0x21];                                  // 0x00F0(0x0021) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VO0D[0x86];                                  // 0x0112(0x0086) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_33AE[0x24];                                  // 0x0050(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J3R6[0x13];                                  // 0x0075(0x0013) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ATXK[0x1F];                                  // 0x00A9(0x001F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_AAPU[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		EPawnActionFailHandling                                    ChildFailureHandlingMode;                                // 0x0098(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_PEI9[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UPawnAction*                                         RecentActionCopy;                                        // 0x00A0(0x0008) ZeroConstructor, Transient, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_3I28[0x8];                                   // 0x00A8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_P5JU[0x3];                                   // 0x00ED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
