...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_X5TP[0x7];                                   // 0x0919(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1WHT[0x5];                                   // 0x092B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
