...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_Y8GJ[0x4];                                   // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void GetRandomPointNoMin(const struct FVector& Origin, struct FVector* _return_);
		void GetRandomPointMin(const struct FVector& Origin, struct FVector* _return_, bool* DidNotFindLoc);
