...
namespace CG
{
	...
	{
	public:
		class UPrimalInventoryBP_Catapult_C*                       PrimalInventoryBP_Catapult_C1;                           // 0x10C8(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		class USkeletalMeshComponent*                              CatapultMesh;                                            // 0x10D0(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
