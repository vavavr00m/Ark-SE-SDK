...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3RT9[0x6];                                   // 0x2A22(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NJTF[0x7];                                   // 0x2A41(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
