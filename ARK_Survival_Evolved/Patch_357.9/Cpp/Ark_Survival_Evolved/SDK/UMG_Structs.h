...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_FWEY[0xA0];                                  // 0x0000(0x00A0) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_FAIQ[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_0G5T[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_5DL1[0x7];                                   // 0x0021(0x0007) MISSED OFFSET (PADDING)
	};
