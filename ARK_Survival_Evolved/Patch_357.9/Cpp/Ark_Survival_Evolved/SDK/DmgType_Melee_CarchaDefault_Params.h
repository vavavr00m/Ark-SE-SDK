...
namespace CG
{
	 ...
	 */
	struct UDmgType_Melee_CarchaDefault_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_OK91[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		...
		unsigned char                                              UnknownData_KH7G[0x4];                                   // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
