...
namespace CG
{
	 ...
	 * Parameters:
	 * 		TArray<struct FAvoidanceArea>                      _return_                                                   (Parm, OutParm, ZeroConstructor)
	 */
	void ADesertKaiju_FirstFlockChar_BP_C::GetFlockAvoidanceArea(TArray<struct FAvoidanceArea>* _return_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
