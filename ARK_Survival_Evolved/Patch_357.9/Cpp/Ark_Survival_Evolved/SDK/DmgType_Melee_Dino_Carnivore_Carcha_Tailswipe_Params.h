...
namespace CG
{
	 ...
	 */
	struct UDmgType_Melee_Dino_Carnivore_Carcha_Tailswipe_C_BPAdjustDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_KCJV[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
