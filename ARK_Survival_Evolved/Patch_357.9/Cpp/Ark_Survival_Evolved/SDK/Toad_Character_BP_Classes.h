...
namespace CG
{
	...
	{
	public:
		class UDinoCharacterStatusComponent_BP_Toad_C*             DinoCharacterStatus_BP_Toad_C1;                          // 0x2288(0x0008) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
	...
	public:
		...
		void ExecuteUbergraph_Toad_Character_BP(int32_t EntryPoint);
