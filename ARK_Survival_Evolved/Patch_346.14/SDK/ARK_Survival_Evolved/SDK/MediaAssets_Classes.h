...
namespace CG
{
	...
	public:
		...
		unsigned char                                              AutoPlay : 1;                                            // 0x0048(0x0001) BIT_FIELD Edit, NoDestructor, Protected
		unsigned char                                              UnknownData_TFN5[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                                      AutoPlayRate;                                            // 0x004C(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected
		unsigned char                                              Looping : 1;                                             // 0x0050(0x0001) BIT_FIELD Edit, NoDestructor, Protected
		unsigned char                                              UnknownData_2OUK[0x3];                                   // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J0KC[0x3];                                   // 0x0055(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FString                                              URL;                                                     // 0x0058(0x0010) Edit, ZeroConstructor, Protected
		unsigned char                                              UnknownData_IWSH[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZQJB[0x4];                                   // 0x0204(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UMediaPlayer*                                        MediaPlayer;                                             // 0x0208(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_MXII[0x38];                                  // 0x0210(0x0038) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_N1Y4[0x2];                                   // 0x00B2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7A0B[0x38];                                  // 0x00D0(0x0038) MISSED OFFSET (PADDING)
