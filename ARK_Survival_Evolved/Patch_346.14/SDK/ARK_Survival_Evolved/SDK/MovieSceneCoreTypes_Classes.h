...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_WFU8[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6YGE[0x10];                                  // 0x0048(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                              UnknownData_3H39[0x4];                                   // 0x01DC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_52RP[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
