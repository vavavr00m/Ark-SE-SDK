...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_E6EZ[0x18];                                  // 0x04C0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              bLOSflag : 1;                                            // 0x04D8(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              bSkipExtraLOSChecks : 1;                                 // 0x04D8(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              bAllowStrafe : 1;                                        // 0x04D8(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              bWantsPlayerState : 1;                                   // 0x04D8(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              bUse3DGoalRadius : 1;                                    // 0x04D8(0x0001) BIT_FIELD Edit, DisableEditOnInstance, NoDestructor
		unsigned char                                              bForceInputAcceptanceRadius : 1;                         // 0x04D8(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor
		unsigned char                                              UnknownData_CYFW[0x7];                                   // 0x04D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UBrainComponent*                                     BrainComponent;                                          // 0x04E0(0x0008) BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor
		class UAIPerceptionComponent*                              PerceptionComponent;                                     // 0x04E8(0x0008) ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor
		struct FVector                                             MoveTowardTargetOffset;                                  // 0x04F0(0x000C) BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor
		struct FVector                                             TargetFocalPositionOffset;                               // 0x04FC(0x000C) BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor
		float                                                      ReachedDestinationThresholdOffset;                       // 0x0508(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		float                                                      MovementGoalHeight;                                      // 0x050C(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		class FScriptMulticastDelegate                             ReceiveMoveCompleted;                                    // 0x0510(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable
		unsigned char                                              UnknownData_8BS3[0x70];                                  // 0x0520(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              UnknownData_R45U : 1;                                    // 0x0590(0x0001) BIT_FIELD (PADDING)
		unsigned char                                              bLastMoveReachedGoal : 1;                                // 0x0590(0x0001) BIT_FIELD BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor
		unsigned char                                              bLastRequestedMoveToLocationWasPlayerCommand : 1;        // 0x0590(0x0001) BIT_FIELD BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor
		unsigned char                                              UnknownData_TS99[0x7];                                   // 0x0591(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3GQT[0x8];                                   // 0x0048(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DYKH[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JFPC[0x8];                                   // 0x0060(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_QZ97[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_10LJ[0x18];                                  // 0x0048(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_OLFG[0x8];                                   // 0x0108(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_CX15[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_815X[0x2C];                                  // 0x008C(0x002C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_51WJ[0x4];                                   // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class AAIController*                                       AIOwner;                                                 // 0x00F0(0x0008) ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected
		unsigned char                                              UnknownData_5MS8[0x58];                                  // 0x00F8(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		ECorePerceptionTypes                                       DominantSense;                                           // 0x0150(0x0001) ZeroConstructor, Config, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_P0N5[0x37];                                  // 0x0151(0x0037) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_CIRT[0x20];                                  // 0x0030(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NG7Q[0x60];                                  // 0x0050(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NP3F[0x4];                                   // 0x00B8(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EIJM[0x4];                                   // 0x00C4(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RYT2[0x8];                                   // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6U53[0x28];                                  // 0x00F0(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Y2PD[0x48];                                  // 0x0118(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UBTNode*>                                     NodeInstances;                                           // 0x0160(0x0010) ZeroConstructor, Transient, Protected
		unsigned char                                              UnknownData_0GKQ[0x80];                                  // 0x0170(0x0080) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_BH37[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4KP7[0x8];                                   // 0x0058(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JYM8[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_UDOA[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9TW0[0x8];                                   // 0x0040(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_IFSX[0x88];                                  // 0x00E8(0x0088) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8JG8[0x7];                                   // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_M3US : 7;                                    // 0x0058(0x0001) BIT_FIELD (PADDING)
		unsigned char                                              bInverseCondition : 1;                                   // 0x0058(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              UnknownData_LZGR[0x3];                                   // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		EBTFlowAbortMode                                           FlowAbortMode;                                           // 0x005C(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected
		unsigned char                                              UnknownData_L9ND[0x3];                                   // 0x005D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XM5E[0x8];                                   // 0x0088(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_Q3WP[0x6];                                   // 0x00BA(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DCWI[0x20];                                  // 0x0060(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              bShowPropertyDetails : 1;                                // 0x0080(0x0001) BIT_FIELD Edit, DisableEditOnTemplate, NoDestructor, Protected
		unsigned char                                              UnknownData_6BN9[0xF];                                   // 0x0081(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_Q6U6[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9C7T[0x8];                                   // 0x00B8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_UJNE[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XPL8[0x8];                                   // 0x00E0(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_QIZ8[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              bUseSelf : 1;                                            // 0x00B0(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              UnknownData_W73N[0x3];                                   // 0x00B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		EPathExistanceQueryType                                    PathQueryType;                                           // 0x00B4(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_6C89[0x3];                                   // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		float                                                      ConeHalfAngle;                                           // 0x0060(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_35ZL[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FBlackboardKeySelector                              ConeOrigin;                                              // 0x0068(0x0028) Edit
		struct FBlackboardKeySelector                              Observed;                                                // 0x0090(0x0028) Edit
		unsigned char                                              bUseSelfAsOrigin : 1;                                    // 0x00B8(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              bUseSelfAsObserved : 1;                                  // 0x00B8(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              UnknownData_Y8AB[0x7];                                   // 0x00B9(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6NO1[0x3];                                   // 0x0065(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LF0J[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_20DS[0x10];                                  // 0x0068(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              bShowPropertyDetails : 1;                                // 0x0078(0x0001) BIT_FIELD Edit, DisableEditOnTemplate, NoDestructor, Protected
		unsigned char                                              UnknownData_NLAW[0x7];                                   // 0x0079(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TTQM[0x7];                                   // 0x0081(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              bAutoStopOnAbort : 1;                                    // 0x0084(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              bForceMoveToLocation : 1;                                // 0x0084(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              bProjectVectorGoalToNavigation : 1;                      // 0x0084(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              bAllowStrafe : 1;                                        // 0x0084(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              UnknownData_CZJW[0x3];                                   // 0x0085(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		float                                                      AcceptableRadius;                                        // 0x0080(0x0004) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_BLIZ[0x4];                                   // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UClass*                                              FilterClass;                                             // 0x0088(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              bAllowStrafe : 1;                                        // 0x0090(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              UnknownData_WJ5V[0x7];                                   // 0x0091(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_H4DP[0x4];                                   // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FBlackboardKeySelector                              PrecisionKey;                                            // 0x0088(0x0028) Edit, Protected
		unsigned char                                              bForceUpdatePrecision : 1;                               // 0x00B0(0x0001) BIT_FIELD Edit, NoDestructor, Protected
		unsigned char                                              bZeroPrecisionSucceedsInstantly : 1;                     // 0x00B0(0x0001) BIT_FIELD Edit, NoDestructor, Protected
		unsigned char                                              bIgnorePitch : 1;                                        // 0x00B0(0x0001) BIT_FIELD Edit, NoDestructor, Protected
		unsigned char                                              UnknownData_XKKP[0x7];                                   // 0x00B1(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_89T4[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_C8V2[0x18];                                  // 0x0058(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              bShowPropertyDetails : 1;                                // 0x0070(0x0001) BIT_FIELD Edit, DisableEditOnTemplate, NoDestructor, Protected
		unsigned char                                              UnknownData_08IP[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RO8W[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_OOTK[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NXUD[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4XAM[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_WDRY[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		struct FEnvFloatParam                                      Radius;                                                  // 0x0040(0x000C) Edit, DisableEditOnInstance
		unsigned char                                              UnknownData_CILS[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FText                                                GeneratorsActionDescription;                             // 0x0050(0x0018) ELEMENT_SIZE_MISMATCH Edit
		unsigned char                                              UnknownData_IJJ7[0x10];                                  // 0x004C(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_HNUH[0x8];                                   // 0x0088(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_366A[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6JOE[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              bDefineArc : 1;                                          // 0x00E0(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              UnknownData_GBDV[0x7];                                   // 0x00E1(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_5H0U[0x30];                                  // 0x0028(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YCVI[0x2];                                   // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S5T8[0x1];                                   // 0x0063(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JDKS[0x2];                                   // 0x0066(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_C2ZN[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FEnvFloatParam                                      Weight;                                                  // 0x0084(0x000C) Edit, DisableEditOnInstance
		unsigned char                                              UnknownData_EU8D[0x8];                                   // 0x0090(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              UnknownData_HVPV : 1;                                    // 0x0098(0x0001) BIT_FIELD (PADDING)
		unsigned char                                              bWorkOnFloatValues : 1;                                  // 0x0098(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              bDiscardFailedItems : 1;                                 // 0x0098(0x0001) BIT_FIELD NoDestructor
		unsigned char                                              UnknownData_UGMH[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PG0B[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_1540[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XMLA[0x4];                                   // 0x00D4(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_B212[0x4];                                   // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_DHZZ[0x10];                                  // 0x0670(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UEnvQuery*                                           QueryTemplate;                                           // 0x06C0(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		TArray<struct FEnvNamedValue>                              QueryParams;                                             // 0x06C8(0x0010) Edit, ZeroConstructor
		float                                                      TimeLimitPerStep;                                        // 0x06D8(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		int32_t                                                    StepToDebugDraw;                                         // 0x06DC(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              bDrawLabels : 1;                                         // 0x06E0(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              bDrawFailedItems : 1;                                    // 0x06E0(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              bReRunQueryOnlyOnFinishedMove : 1;                       // 0x06E0(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              bShouldBeVisibleInGame : 1;                              // 0x06E0(0x0001) BIT_FIELD Edit, NoDestructor
		unsigned char                                              UnknownData_6CLP[0x3];                                   // 0x06E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		EEnvQueryRunMode                                           QueryingMode;                                            // 0x06E4(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_A4MO[0x2B];                                  // 0x06E5(0x002B) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GSBW[0x8];                                   // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PH9S[0x21];                                  // 0x00F0(0x0021) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              bDoAsyncPathfinding : 1;                                 // 0x0111(0x0001) BIT_FIELD Config, NoDestructor, Protected
		unsigned char                                              bDoHierarchicalPathfinding : 1;                          // 0x0111(0x0001) BIT_FIELD Config, NoDestructor, Protected
		unsigned char                                              bSearchFromGoalWhenOutOfNodes : 1;                       // 0x0111(0x0001) BIT_FIELD Config, NoDestructor, Protected
		unsigned char                                              UnknownData_ODBB[0x86];                                  // 0x0112(0x0086) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_9M0L[0x24];                                  // 0x0050(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              bAllowNewSameClassInstance : 1;                          // 0x0074(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected
		unsigned char                                              bReplaceActiveSameClassInstance : 1;                     // 0x0074(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, Protected
		unsigned char                                              UnknownData_CMYA[0x13];                                  // 0x0075(0x0013) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              bAllowStrafe : 1;                                        // 0x00A8(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, Protected
		unsigned char                                              UnknownData_BSNM[0x1F];                                  // 0x00A9(0x001F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_QT1H[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		EPawnActionFailHandling                                    ChildFailureHandlingMode;                                // 0x0098(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_XGYK[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UPawnAction*                                         RecentActionCopy;                                        // 0x00A0(0x0008) ZeroConstructor, Transient, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_R85V[0x8];                                   // 0x00A8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              bEnableSensingUpdates : 1;                               // 0x00EC(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor
		unsigned char                                              bOnlySensePlayers : 1;                                   // 0x00EC(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor
		unsigned char                                              bSeePawns : 1;                                           // 0x00EC(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor
		unsigned char                                              bHearNoises : 1;                                         // 0x00EC(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor
		unsigned char                                              UnknownData_W1ZI[0x3];                                   // 0x00ED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
