...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_X5WA[0xA0];                                  // 0x0000(0x00A0) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_9EGB[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_Y242[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_OQ07[0x7];                                   // 0x0021(0x0007) MISSED OFFSET (PADDING)
	};
