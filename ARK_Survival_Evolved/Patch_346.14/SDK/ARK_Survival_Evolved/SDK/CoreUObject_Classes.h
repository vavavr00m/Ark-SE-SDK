...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_P22P[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_OA50[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_72MWYW4G7J[0x4];                                     // 0x0044(0x0004) PRE-DEFINED PROPERTY
		TArray<unsigned char>                                      Script;                                                  // 0x0048(0x0010) PRE-DEFINED PROPERTY
		int                                                        MinAlignment;                                            // 0x0058(0x0004) PRE-DEFINED PROPERTY
		unsigned char                                              pad_LEEPXHYL2O[0x4];                                     // 0x005C(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_2Y1L[0x18];                                  // 0x0090(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ZH4P[0x68];                                  // 0x0028(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_9L3D[0xF8];                                  // 0x0090(0x00F8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_Y15EDBVRVG[0x1];                                     // 0x0096(0x0001) PRE-DEFINED PROPERTY
		unsigned char                                              pad_9TSJD3ZMVJ[0x1];                                     // 0x0097(0x0001) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_LF6R[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3I26[0x28];                                  // 0x0030(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HCHW[0x198];                                 // 0x0028(0x0198) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x04B0 (FullSize[0x0670] - InheritedSize[0x01C0])
	 */
	class ULinkerLoad : public ULinker
	{
	public:
		unsigned char                                              UnknownData_YHOR[0x4B0];                                 // 0x01C0(0x04B0) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0118 (FullSize[0x02D8] - InheritedSize[0x01C0])
	 */
	class ULinkerSave : public ULinker
	{
	public:
		unsigned char                                              UnknownData_XE2E[0x118];                                 // 0x01C0(0x0118) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3BWX[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_T43W[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DW2K[0x40];                                  // 0x0030(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_P80M[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_B2FC[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_6NC3[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_XMC0[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_O28R[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WY0J[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_KXYN[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_6CGW[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Z7UL[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
