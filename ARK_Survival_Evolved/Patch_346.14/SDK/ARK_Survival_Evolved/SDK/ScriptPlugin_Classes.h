...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_AZVG[0x8];                                   // 0x00D8(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_02CO[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0CXT[0x8];                                   // 0x00D8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_QIA4[0x3];                                   // 0x047D(0x0003) MISSED OFFSET (PADDING)
