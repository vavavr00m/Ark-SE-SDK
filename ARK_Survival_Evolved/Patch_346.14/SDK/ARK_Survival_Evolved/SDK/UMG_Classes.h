...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_P1NW[0x6];                                   // 0x002A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZUQJ[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_F34V[0x10];                                  // 0x0060(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_JWDS[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YGBR[0x8];                                   // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		ESlateVisibility                                           Visiblity;                                               // 0x00D0(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_BZ9V[0x3];                                   // 0x00D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JNJI[0x3];                                   // 0x00E5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_84OV[0x40];                                  // 0x0140(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       bDesignTime;                                             // 0x0180(0x0001) ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected
		unsigned char                                              UnknownData_0OBI[0x7];                                   // 0x0181(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_HHMU[0x3];                                   // 0x018D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                                      DPIScaler;                                               // 0x0190(0x0004) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_6GAC[0x4];                                   // 0x0194(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1MKP[0x70];                                  // 0x01D0(0x0070) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GU3W[0x4];                                   // 0x019C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_28UL[0x3];                                   // 0x03F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_35T1[0x2];                                   // 0x0416(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              IsFocusable : 1;                                         // 0x0418(0x0001) BIT_FIELD Edit, DisableEditOnInstance, NoDestructor, AdvancedDisplay
		unsigned char                                              bForceHandleMouseDown : 1;                               // 0x0418(0x0001) BIT_FIELD Edit, DisableEditOnInstance, NoDestructor, AdvancedDisplay
		unsigned char                                              bRedirectGamepadPressToClick : 1;                        // 0x0418(0x0001) BIT_FIELD Edit, DisableEditOnInstance, NoDestructor, AdvancedDisplay
		unsigned char                                              UnknownData_4HXQ[0x7];                                   // 0x0419(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GR6Z[0x10];                                  // 0x0480(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2CEY[0x3];                                   // 0x05F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HPSQ[0x1];                                   // 0x0617(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_36LG[0x16];                                  // 0x062A(0x0016) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1HG7[0x6];                                   // 0x01D2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IEWJ[0x3];                                   // 0x0281(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_57HH[0x14];                                  // 0x02C4(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_R6LY[0x10];                                  // 0x0188(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_S1UT[0x10];                                  // 0x01C0(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_B6D9[0x2];                                   // 0x049A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TO3J[0x3];                                   // 0x04A5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5ZDK[0x10];                                  // 0x04C8(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_L1TN[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_X34L[0x50];                                  // 0x0040(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PBWC[0x16];                                  // 0x004A(0x0016) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GU70[0x16];                                  // 0x004A(0x0016) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_49ZW[0x3];                                   // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    ZOrder;                                                  // 0x0064(0x0004) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_YYRJ[0x8];                                   // 0x0068(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YMMB[0x2];                                   // 0x003A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J348[0x8];                                   // 0x0058(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_C6A6[0xE];                                   // 0x0052(0x000E) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0049(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_22ER[0xE];                                   // 0x004A(0x000E) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0049(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_LZDI[0x16];                                  // 0x004A(0x0016) MISSED OFFSET (PADDING)
	...
	public:
		struct FMargin                                             Padding;                                                 // 0x0038(0x0010) Edit, DisableEditOnInstance
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_SDDD[0xF];                                   // 0x0049(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0049(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected
		unsigned char                                              UnknownData_AIWK[0x16];                                  // 0x004A(0x0016) MISSED OFFSET (PADDING)
	...
	public:
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0038(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0039(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_FTC7[0x2];                                   // 0x003A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    Row;                                                     // 0x003C(0x0004) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		int32_t                                                    Column;                                                  // 0x0040(0x0004) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_SD70[0xC];                                   // 0x0044(0x000C) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0050(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0051(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_EOJM[0xE];                                   // 0x0052(0x000E) MISSED OFFSET (PADDING)
	...
	public:
		...
		EHorizontalAlignment                                       HorizontalAlignment;                                     // 0x0048(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		EVerticalAlignment                                         VerticalAlignment;                                       // 0x0049(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_7AY2[0xE];                                   // 0x004A(0x000E) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_I8J0[0x4];                                   // 0x0194(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_720E[0x10];                                  // 0x0218(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_94VP[0x10];                                  // 0x01A8(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6R0M[0x3];                                   // 0x05C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SXXK[0x40];                                  // 0x05F8(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ULRH[0x10];                                  // 0x06A0(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_0ANE[0x10];                                  // 0x06D8(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_A8EQ[0x2];                                   // 0x0762(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_12XS[0x2];                                   // 0x077E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B2PM[0x10];                                  // 0x07A0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MZVU[0x3];                                   // 0x0239(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CVA6[0x14];                                  // 0x024C(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FGB4[0x10];                                  // 0x02A0(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_I4R0[0x2];                                   // 0x02CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J415[0x10];                                  // 0x0310(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_CE4U[0x10];                                  // 0x07B8(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_8LM1[0x2];                                   // 0x07E2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                                      WrapTextAt;                                              // 0x07E4(0x0004) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay
		unsigned char                                              UnknownData_4QJZ[0x10];                                  // 0x07E8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CRCF[0x10];                                  // 0x0868(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_03TT[0x10];                                  // 0x0188(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SAXX[0x18];                                  // 0x01C0(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7JDF[0x3];                                   // 0x06F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KINC[0x3];                                   // 0x070D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P9U3[0x10];                                  // 0x0758(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_E05Y[0x7];                                   // 0x01A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7ZVA[0x3];                                   // 0x01D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVector2D                                           Padding;                                                 // 0x01D4(0x0008) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_PWEH[0x14];                                  // 0x01DC(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_DYGV[0x16];                                  // 0x01A2(0x0016) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              bOverride_WidthOverride : 1;                             // 0x01A0(0x0001) BIT_FIELD NoDestructor, Protected
		unsigned char                                              bOverride_HeightOverride : 1;                            // 0x01A0(0x0001) BIT_FIELD NoDestructor, Protected
		unsigned char                                              bOverride_MinDesiredWidth : 1;                           // 0x01A0(0x0001) BIT_FIELD NoDestructor, Protected
		unsigned char                                              bOverride_MinDesiredHeight : 1;                          // 0x01A0(0x0001) BIT_FIELD NoDestructor, Protected
		unsigned char                                              bOverride_MaxDesiredWidth : 1;                           // 0x01A0(0x0001) BIT_FIELD NoDestructor, Protected
		unsigned char                                              bOverride_MaxDesiredHeight : 1;                          // 0x01A0(0x0001) BIT_FIELD NoDestructor, Protected
		unsigned char                                              UnknownData_FNG3[0x3];                                   // 0x01A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9FF1[0x14];                                  // 0x01BC(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RS8H[0x20];                                  // 0x01B0(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_CKVM[0x10];                                  // 0x01C0(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_I4ND[0x10];                                  // 0x01A0(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TB60[0x10];                                  // 0x01A0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GWLB[0x2];                                   // 0x040A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVector2D                                           Thickness;                                               // 0x040C(0x0008) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_9AMB[0x14];                                  // 0x0414(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YMHM[0x10];                                  // 0x01B8(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RTQJ[0x10];                                  // 0x01A0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_I51S[0x14];                                  // 0x01A4(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KDEZ[0x1];                                   // 0x031B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OYD3[0x14];                                  // 0x0344(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TBX0[0x3];                                   // 0x0385(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_72C7[0x6];                                   // 0x03AA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YTTR[0x10];                                  // 0x03E0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_K4DX[0x10];                                  // 0x0190(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_OD9L[0x4];                                   // 0x0434(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_31KN[0x2];                                   // 0x045E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              bOverride_MinValue : 1;                                  // 0x04D8(0x0001) BIT_FIELD NoDestructor, Protected
		unsigned char                                              bOverride_MaxValue : 1;                                  // 0x04D8(0x0001) BIT_FIELD NoDestructor, Protected
		unsigned char                                              bOverride_MinSliderValue : 1;                            // 0x04D8(0x0001) BIT_FIELD NoDestructor, Protected
		unsigned char                                              bOverride_MaxSliderValue : 1;                            // 0x04D8(0x0001) BIT_FIELD NoDestructor, Protected
		unsigned char                                              UnknownData_CRMC[0x3];                                   // 0x04D9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JS9K[0x14];                                  // 0x04EC(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3W63[0x4];                                   // 0x018C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5XSO[0x3];                                   // 0x01A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UNTI[0x14];                                  // 0x01B4(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		TArray<class UObject*>                                     Items;                                                   // 0x0190(0x0010) Edit, BlueprintVisible, ZeroConstructor
		ESelectionMode                                             SelectionMode;                                           // 0x01A0(0x0001) Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_M12Q[0x3];                                   // 0x01A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YTYA[0x14];                                  // 0x01B4(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_IDLJ[0x10];                                  // 0x02A8(0x0010) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_SFKH[0x3];                                   // 0x0365(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_C1JH[0x14];                                  // 0x0384(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_QTHT[0x1];                                   // 0x018F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KUQ7[0x10];                                  // 0x0210(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ECSU[0x10];                                  // 0x0200(0x0010) MISSED OFFSET (PADDING)
